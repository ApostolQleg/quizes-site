				...
				questions: [
					...
					},
					{
						...
						options: [
							...
							{ text: "have bought", id: 4, isCorrect: false },
						],
					},
					{
				...
				questions: [
					...
					},
					{
						...
						options: [
							...
							{ text: "Павло Чубинський", id: 2, isCorrect: true },
							{ text: "Леся Українка", id: 3, isCorrect: false },
							{ text: "Михайло Вербицький", id: 4, isCorrect: false },
						],
					},
					{
				...
				questions: [
					...
					},
					{
						...
						options: [
							...
							{ text: "Південна Америка", id: 4, isCorrect: false },
						],
					},
					{
				...
				questions: [
					{
						...
						options: [
							...
							{ text: "const x = 1;", id: 2, isCorrect: true },
							{ text: "let x = 1;", id: 3, isCorrect: false },
							{ text: "constant x = 1;", id: 4, isCorrect: false },
						],
					},
					{
				...
				questions: [
					{
						...
						options: [
							{ text: "Мітохондрії", id: 1, isCorrect: false },
					...
					},
					{
						...
						options: [
							...
							{ text: "Хлоропласти", id: 4, isCorrect: false },
						],
					},
				],
			},
				...
				questions: [
					{
						...
						options: [
							{ text: "Іван Франко", id: 1, isCorrect: false },
							{ text: "Тарас Шевченко", id: 2, isCorrect: true },
							{ text: "Леся Українка", id: 3, isCorrect: false },
							{ text: "Панас Мирний", id: 4, isCorrect: false },
						],
					},
					{
						text: "Хто написав 'Лісову пісню'?",
						options: [
							{ text: "Ольга Кобилянська", id: 1, isCorrect: false },
							{ text: "Іван Нечуй-Левицький", id: 2, isCorrect: false },
							{ text: "Леся Українка", id: 3, isCorrect: true },
							{ text: "Тарас Шевченко", id: 4, isCorrect: false },
						],
					},
				],
			},
				...
				questions: [
					{
						...
						options: [
							...
							{ text: "Паскаль (Pa)", id: 4, isCorrect: false },
						],
					},
					{
			...
			// --- ТЕСТ 13: Логіка ---
			{
				...
				questions: [
					...
					},
					{
						...
						options: [
							{ text: "Так, завжди", id: 1, isCorrect: false },
							{ text: "Ні, не обов'язково", id: 2, isCorrect: true },
							{ text: "Тільки якщо А = Б", id: 3, isCorrect: false },
							{ text: "Тільки якщо Б = В", id: 4, isCorrect: false },
						],
					},
				],
			},
				...
				questions: [
					{
						...
						options: [
							{ text: "Вінсент Ван Гог", id: 1, isCorrect: false },
							{ text: "Леонардо да Вінчі", id: 2, isCorrect: true },
							{ text: "Пабло Пікассо", id: 3, isCorrect: false },
							{ text: "Мікеланджело", id: 4, isCorrect: false },
						],
					},
					{
						text: "В якому стилі творив Сальвадор Далі?",
						options: [
							{ text: "Імпресіонізм", id: 1, isCorrect: false },
				...
				questions: [
					{
						...
						options: [
							{ text: "Зростання вартості грошей", id: 1, isCorrect: false },
							{
								text: "Зниження купівельної спроможності грошей",
								id: 2,
								isCorrect: true,
							},
							{ text: "Фіксований обмінний курс", id: 3, isCorrect: false },
							{ text: "Накопичення багатства", id: 4, isCorrect: false },
						],
					},
					{
						text: "Що таке 'диверсифікація' у інвестиціях?",
						options: [
							{ text: "Вкладення всіх грошей в один актив", id: 1, isCorrect: false },
							{
